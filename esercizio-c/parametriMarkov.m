...
% Matrice di transizione A. Le colonne sono distribuzioni di probabilita'
% (somma = 1): A(i,j) e' la probabilita' di passare dallo stato j allo
% stato i. Essendo stocastica per colonne, A ammette 1 come autovalore e
% un autovettore associato che e' la distribuzione stazionaria.
A = [1/5  5/19  3/11;
     1/3  9/19  7/22;
     7/15 5/19  9/22]

%% Scelta di uno stato iniziale x0 random
% x0 e' una distribuzione di probabilita' iniziale generata in modo
% pseudo-casuale e poi normalizzata (somma = 1). La scelta e' arbitraria:
